...
$article = array(
    array("mimi"=>1227401120, "icon"=>"spring.jpg", 'name'=>'春天', 'text'=>'播种','pic'=>'aaaaaaaaaa.png'),
    array("mimi"=>1227401120, "icon"=>"summer.png", 'name'=>'夏天', 'text'=>'避暑','pic'=>'bbbbbbbbbbbbbbbbbbbbbbbbbbbbb.png'),
    array("mimi"=>1227401120, "icon"=>"autumn.gif", 'name'=>'秋天', 'text'=>'收获','pic'=>'ccccccccccc.gif'),
    array("mimi"=>1227401120, "icon"=>"winter.jpg", 'name'=>'冬天', 'text'=>'吃饺子','pic'=>'dddddddddddddddddddddddddddddddddddddddddddddd.jpg')
);
for ($i = 0; $i != 4; ++$i) {
    $feedid = new feedid();
    $feedid->mimi = 1227401140 + $i;
    $feedid->cmd_id = 7003;
    $feedid->version = 1;
    ...
    $aid = 150001 + $i;
    $pic = $article[$i]['pic'];
    $len = 2 + 2 + 4 + 1 + 4 + 4  + 4  + 1 + strlen($pic);
    
    $f_arr_1 = pack('S',$len).$feedid_binary.pack('LLc', 7003, $aid, strlen($pic)).$pic;
